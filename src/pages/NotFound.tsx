...
export default function NotFound() {
    ...
    return (
        ...
        .notfound-page .world .box .wall:nth-child(1) {
          transform: translateZ(100px);
        }

        .notfound-page .world .box .wall:nth-child(2) {
          transform: rotateX(180deg) translateZ(100px);
        }

        .notfound-page .world .box .wall:nth-child(3) {
        ...
        .notfound-page .world .box .wall:nth-child(4) {
          transform: rotateX(-90deg) translateZ(100px);
        }
        ...
        .notfound-page .world .box .wall:nth-child(5) {
        ...
        .notfound-page .world .box .wall:nth-child(6) {
          transform: rotateY(-90deg) translateZ(100px);
        }
